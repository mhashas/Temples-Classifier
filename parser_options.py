...
class ParserOptions():
    ...
    def __init__(self):
        ...
        parser.add_argument('--use_class_weights', type=int, default=0, choices=[0,1], help='if we should use class weights to deal with imbalanced dataset')
        ...
        parser.add_argument('--trainval', type=int, default=1, choices=[0,1], help='determines whether whe should use validation images as well for training')
